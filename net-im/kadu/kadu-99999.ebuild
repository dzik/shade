...
EGIT_REPO_URI="git://gitorious.org/kadu/kadu.git"
...
#		|| die ".config creation failed"
	...
	# Common modules
#	config_enable module_account_management n
#	config_enable module_advanced_userlist n
#	config_enable module_antistring n
#	config_enable module_auto_hide m
#	config_enable module_autoaway n
#	config_enable module_autoresponder n
#	config_enable module_autostatus n
#	config_enable module_cenzor n
#	config_enable module_dcc m
#	config_enable module_desktop_docking n
#	config_enable module_docking m
#	config_enable module_echo n
#	config_enable module_exec_notify n
#	config_enable module_ext_sound m
#	config_enable module_filedesc n
...
#	config_enable module_pcspeaker n
...
#	config_enable module_word_fix n
#	config_enable module_nextinfo m
#	config_enable module_idle m
#	config_enable module_tabs m
#	config_enable module_plus_pl_sms n

	# Enable support for all media players since then don't require any build time dependencies
#	config_enable module_mediaplayer n
#	config_enable module_amarok1_mediaplayer n
#	config_enable module_amarok2_mediaplayer n
#	config_enable module_audacious_mediaplayer n
#	config_enable module_dragon_mediaplayer n
	# falf_mediaplayer
	# itunes_mediaplayer
#	config_enable module_vlc_mediaplayer n
	# xmms2_mediaplayer
	# xmms_mediaplayer
